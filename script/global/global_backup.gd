...
func save(save_path) -> void:
	...
	if save_file:
		...
		print("Backup error: Unable to open file for writing: ", save_path)
...
func load_save(save_path):
	...
	if FileAccess.file_exists(save_path):
		...
		if save_file:
			...
			print("Error opening file for reading: ", save_path)
	else:
